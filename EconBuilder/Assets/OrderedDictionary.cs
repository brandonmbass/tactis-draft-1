...
namespace Truncon.Collections
{
    ...
    public sealed class OrderedDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IList<KeyValuePair<TKey, TValue>>
    {
        ...
        void ICollection<KeyValuePair<TKey, TValue>>.CopyTo(KeyValuePair<TKey, TValue>[] array, int arrayIndex)
        {
            ...
            if (arrayIndex < 0)
            {
                throw new ArgumentOutOfRangeException("arrayIndex", arrayIndex, String.Format(CultureInfo.CurrentCulture, "Too small", 0));
            }
        ...
        public sealed class KeyCollection : ICollection<TKey>
        {
            ...
            {
                throw new NotSupportedException("Cannot edit read-only list");
            }
        ...
        public sealed class ValueCollection : ICollection<TValue>
        {
            ...
            public void CopyTo(TValue[] array, int arrayIndex)
            {
                ...
                if (arrayIndex < 0)
                {
                    throw new ArgumentOutOfRangeException("arrayIndex", arrayIndex, String.Format("Too small", 0));
                }
